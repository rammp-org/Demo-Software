...
class JoystickThread(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.joystick_pins = {"Forward": 20, "Reverse": 17, "Left": 27, "Right": 18}
    ...
    def run(self):
        try:
            while not self.isInterruptionRequested():
                ...
                if (
                    forward_state != self.prev_joystick_state["Forward"]
                    or reverse_state != self.prev_joystick_state["Reverse"]
                    or left_state != self.prev_joystick_state["Left"]
                    or right_state != self.prev_joystick_state["Right"]
                ):
