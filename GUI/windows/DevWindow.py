...
class DevWindow(QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.lc_forward_btn.setText(_translate("MainWindow", "L CARRIAGE F"))
        self.lc_backward_btn.setText(_translate("MainWindow", "L CARRIAGE B"))
        self.rc_forward_btn.setText(_translate("MainWindow", "R CARRIAGE F"))
        self.rc_backward_btn.setText(_translate("MainWindow", "R CARRIAGE B"))