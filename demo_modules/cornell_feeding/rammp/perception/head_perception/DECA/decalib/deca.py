...
class DECA(nn.Module):
    ...
    def decode(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        if return_vis:
            visdict = {'landmarks2d': util.tensor_vis_landmarks(images, landmarks2d)}
        ...
        #     opdict['landmarks2d_image'] = trans_verts
        #     visdict = {
        #         'inputs': images, 
    ...
    # @torch.no_grad()
    def minimal_decode(self, codedict, tform=None, visualize=False, original_images=None):
        ...
        if visualize:
            visdict = {
                'landmarks2d': util.tensor_vis_landmarks(original_images, landmarks2d),
                'landmarks3d': util.tensor_vis_landmarks(original_images, landmarks3d)
            }
    ...
    def save_obj(self, filename, opdict):
        ...
        #  Don't need detailed mesh for our use case
