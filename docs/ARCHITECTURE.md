...
- **Teensy 4.1 Firmware (`firmware/Base`)**: Hard real-time execution engine for running 12 independent PID loops across 6 joints. It handles low-level PWM outputs to RoboClaws, encoder reads, IMU polling, and EEPROM configuration management.
