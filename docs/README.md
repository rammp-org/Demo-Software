...
2. **[Base Firmware](firmware/README.md)**: The C++ Arduino/Teensy firmware responsible for hard real-time motor control, PID execution, sensor integration (IMU, Encoders), and system safety.
