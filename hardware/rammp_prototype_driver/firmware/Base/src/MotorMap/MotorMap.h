...
// Replaces 4+ duplicated switch statements that map motor IDs to encoder
// indices.
//
// Reference mapping (defined in Base.ino):
// Index 0 (id=1): rc,          enc=3,  roboclaw_casters,  M1, offset=true,
// seq=true,  "rc" Index 1 (id=2): fc,          enc=2,  roboclaw_casters,  M2,
// offset=true,  seq=true,  "fc" Index 2 (id=3): ml,          enc=7,
// roboclaw_main,     M1, offset=true,  seq=true,  "ml" Index 3 (id=4): mr,
// enc=5,  roboclaw_main,     M2, offset=true,  seq=true,  "mr" Index 4 (id=5):
// ml_carriage, enc=11, roboclaw_carriages,M1, offset=true,  seq=true,
// "ml_carriage" Index 5 (id=6): mr_carriage, enc=12, roboclaw_carriages,M2,
// offset=true,  seq=true,  "mr_carriage" Index 6 (id=7): drive_fb,    enc=9,
// nullptr,           0,  offset=false, seq=false, "drive_fb" Index 7 (id=8):
