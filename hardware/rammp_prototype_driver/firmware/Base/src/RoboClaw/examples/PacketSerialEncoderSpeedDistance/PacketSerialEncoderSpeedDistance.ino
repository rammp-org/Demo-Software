...
void loop() {
  ...
  do {
    ...
    roboclaw.ReadBuffers(address, depth1, depth2);
           ...
           depth2 != 0x80); // Loop until distance command has completed
  ...
  delay(1000); // When no second command is given the motors will automatically
               // slow down to 0 which takes 1 second
